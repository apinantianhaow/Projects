...
function CategorySelector({ selectedCategory, setSelectedCategory, closeModal }) {
  ...
  const categories = [
    "Electronics", "Clothing", "Books", "Home", "Plants", "Art&Handmade", 
    "Collectibles", "Sports", "Kids", "Beauty", "Grocery"
  ];
      ...
      <div className="bg-white p-4 rounded-md w-96">
        ...
        {categories.map((category, index) => (
          <div
            ...
            onClick={() => setTempCategory(category)} // เมื่อคลิก เลือกหมวดหมู่
          >
        ...
        <button 
          ...
          onClick={() => { setSelectedCategory(tempCategory); closeModal(); }}> {/* บันทึกหมวดหมู่ที่เลือก */}
          Save
        </button>
      </div>
    </div>
